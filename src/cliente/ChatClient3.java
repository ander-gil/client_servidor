    ...
    private static class WriteThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                String selectedUser = console.readLine(); // Elige el usuario para chatear
                out.println("ELEGIR_USUARIO:" + selectedUser); // Envia al servidor el usuario elegido

                while ((message = console.readLine()) != null) {
                    if (message.equalsIgnoreCase("chao")) {
                        out.println("DESCONEXION:" + username); // Enviar mensaje de desconexión
                        break;
                    }
